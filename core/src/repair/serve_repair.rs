...
#[cfg_attr(
    ...
    frozen_abi(digest = "B38h5aDLhZKWdYMn8k17yE672jmkQi1kvTbjqHawkrv4")
)]
...
#[cfg_attr(
    feature = "frozen-abi",
    derive(AbiEnumVisitor, AbiExample),
    frozen_abi(digest = "AtMAiZFtpmFEEnpojCThzXJimTq2DSkykgHqHFJqeHzj")
)]
#[derive(Debug, Deserialize, Serialize)]
...
#[cfg_attr(
    feature = "frozen-abi",
    derive(AbiEnumVisitor, AbiExample),
    frozen_abi(digest = "9mmAduX8BKCc1KGSUYcYrF4cW9k1a2jUEhEoPu7BTN26")
)]
#[derive(Debug, Deserialize, Serialize)]
