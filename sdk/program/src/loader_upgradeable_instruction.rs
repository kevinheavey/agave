...
pub enum UpgradeableLoaderInstruction {
    ...
    ///   4. `[]` Rent sysvar.
    ///   5. `[]` Clock sysvar.
    ///   6. `[]` System program (`solana_sdk::solana_native_programs::system_program::id()`).
    ...
    ///   2. `[]` System program (`solana_sdk::solana_native_programs::system_program::id()`), optional, used to transfer
