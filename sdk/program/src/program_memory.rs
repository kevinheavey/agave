...
pub fn sol_memcpy(dst: &mut [u8], src: &[u8], n: usize) {
    ...
    unsafe {
        solana_syscall_core::sol_memcpy_(dst.as_mut_ptr(), src.as_ptr(), n as u64);
    }
...
pub unsafe fn sol_memmove(dst: *mut u8, src: *mut u8, n: usize) {
    #[cfg(target_os = "solana")]
    solana_syscall_core::sol_memmove_(dst, src, n as u64);
...
pub fn sol_memset(s: &mut [u8], c: u8, n: usize) {
    #[cfg(target_os = "solana")]
    unsafe {
        solana_syscall_core::sol_memset_(s.as_mut_ptr(), c, n as u64);
    }
