...
#[cfg(feature = "bincode")]
use {
    crate::shred_version::compute_shred_version,
...
#[cfg_attr(
    ...
    solana_frozen_abi_macro::frozen_abi(digest = "D9VFRSj4fodCuKFC9omQY2zY2Uw8wo6SzJFLeMJaVigm")
)]
#[cfg_attr(
    feature = "serde",
...
#[cfg(test)]
mod tests {
    use {super::*, solana_keypair::Keypair, solana_signer::Signer, std::path::PathBuf};
